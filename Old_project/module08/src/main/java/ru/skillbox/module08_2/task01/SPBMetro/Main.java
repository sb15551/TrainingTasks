...
public class Main
{
    ...
    private static Marker FOUND;
    private static Marker WRONG;
    private static Marker ERROR;

    private static String dataFile = "module08/src/main/resources/map.json";
    ...
    public static void main(String[] args)
    {
        ...
        FOUND = MarkerManager.getMarker("FOUND");
        WRONG = MarkerManager.getMarker("WRONG");
        ...
        for(;;)
        {
            try {
                ...
                if (from.equals(to)) {
                    throw new IllegalArgumentException("Введите разные станции!!!");
                }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                logger.info(FOUND, message + " - " + line);
                return station;
            }
            logger.warn(WRONG, "Станция не найдена :( " + message + " - " + line);
